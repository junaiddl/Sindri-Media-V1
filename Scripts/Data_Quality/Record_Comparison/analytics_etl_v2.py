...
class Etl:
    ...
    def insert_data_into_prod(self, connection, cursor, siteid, postid):
        ...
        WHERE siteid = {siteid} and postid = {postid};
        """

        print("PROD.PAGES DATA INSERTION QUERIES")
        print(query1)
