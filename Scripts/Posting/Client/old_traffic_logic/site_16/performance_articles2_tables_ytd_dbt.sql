      ...
      CREATE  PROCEDURE `performance_articles2_tables_ytd_dbt_16`()
      BEGIN
...
END
 ...
 AS sektion,
      ...
      and e.date between MAKEDATE(EXTRACT(YEAR FROM CURDATE()),1)  and  DATE_SUB(cast(NOW() as date), INTERVAL 1 DAY) and e.siteid = 16
