    ...
    CREATE  PROCEDURE `performance_articles0_tables_month_dbt_13`()
    BEGIN
 ...
 AS sektion,
    ...
    last_30days_hits as(
      ...
      and e.date between DATE_SUB(NOW(), INTERVAL 31 DAY) and DATE_SUB(NOW(), INTERVAL  1 DAY) and e.siteid = 13
    ...
    from last_30days_hits_pages_goal lg  where gt_goal=1 and siteid = 13;
