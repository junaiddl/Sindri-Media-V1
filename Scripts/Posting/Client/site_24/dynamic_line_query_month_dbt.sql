...
CREATE PROCEDURE `Traffic_dynamic_linequery_month_dbt_24`(
    IN site INT,
...
BEGIN
    ...
    SET @sql_query = CONCAT('
		...
		agg_on_day AS (
			...
			LEFT JOIN prod.traffic_channels_string t ON d.month_name = DATE_FORMAT(t.date, ''%Y-%m'') AND t.siteid = 24
