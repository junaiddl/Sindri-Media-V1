        ...
        CREATE PROCEDURE `performance_articles2_tables_day_dbt_24`()
        BEGIN
 ...
 AS sektion,
        ...
        last_7days_hits as(
            ...
            and e.date between DATE_SUB(NOW(), INTERVAL 8 DAY) and DATE_SUB(NOW(), INTERVAL  1 DAY)  and e.siteid = 24
        ...
        from last_7days_hits_pages_goal lg where gt_goal =1 and siteid=24;
