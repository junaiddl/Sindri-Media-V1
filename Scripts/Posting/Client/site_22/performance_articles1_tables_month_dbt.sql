        ...
        CREATE  PROCEDURE `performance_articles1_tables_month_dbt_22`()
        BEGIN
 ...
 AS sektion,
        ...
        and e.date between DATE_SUB(NOW(), INTERVAL 31 DAY) and DATE_SUB(NOW(), INTERVAL  1 DAY) and e.siteid = 22
        ...
        from last_30days_hits_pages_goal lg where gt_goal=1 and siteid = 22;
