...
BEGIN
  ...
  (
	...
	agg_next_click_per_article_without_others_fourth as(
	...
	last_30_days_article_published_fourth as (
       SELECT a.siteid, a.id, a.fdate, 'others' as Tags
                FROM cms_data a
                LEFT JOIN agg_next_click_per_article_without_others_fourth b
                ON a.siteid = b.siteid AND a.id = b.id
                WHERE b.siteid IS NULL

                UNION ALL

                SELECT * FROM agg_next_click_per_article_without_others_fourth
				),
