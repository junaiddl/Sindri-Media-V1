        ...
        CREATE  PROCEDURE `performance_articles2_card_day_dbt_11`()
        BEGIN
  ...
  NOT (
    ...
    OR categories = 'Seneste nyt'
        ...
        left join prod.events e on e.postid=ldp.id   and e.siteid = ldp.siteid and e.date between DATE_SUB(NOW(), INTERVAL 8 DAY) and DATE_SUB(NOW(), INTERVAL  1 DAY) and e.siteid = 11
        ...
        where l.siteid = 11 -- and l.Event_Action is not null
        union 
        ...
        where p.siteid = 11 -- and -- l.Event_Action is not null
        ),
