...
CREATE PROCEDURE `tactical_userneeds_clicks_chart_ytd_dbt_18`()
BEGIN
    ...
    cta_per_article as (
        ...
        where Event_Action = 'Subscription'  and e.siteid = 18
    ...
    data_out as (
        ...
        'Artikler publiceret år til dato grupperet i tre kategorier: Artikler under CTA mål | Artikler, der klarede mål | Top 10% bedste artikler ift. CTA, En søjle viser hvor stor andel af artiklerne, der falder i hver gruppe. En søjle viser hvor stor en andel af CTA kliks, der er skabt af den gruppe af artikler.' as hint,
    ...
    json_data AS (
        SELECT 
            ...
            COALESCE(hint, 'Artikler publiceret år til dato grupperet i tre kategorier: Artikler under CTA mål | Artikler, der klarede mål | Top 10% bedste artikler ift. CTA, En søjle viser hvor stor andel af artiklerne, der falder i hver gruppe. En søjle viser hvor stor en andel af CTA kliks, der er skabt af den gruppe af artikler.') AS ht, 
