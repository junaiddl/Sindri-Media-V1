...
def insert_data_into_stage_11(cursor, connection, id):
        ...
        try:
            ...
            left JOIN prod.site_archive_post b ON TRIM(TRAILING '/' FROM a.event_name) = TRIM(TRAILING '/' FROM b.link)
            WHERE a.siteid = 11 and a.date = '{end_date}';"""
