        ...
        try:
            ...
            SET RealReferrer = 
                CASE
                    ...
                    -- NL H
                    WHEN referrer_type = 'campaign' AND referrer_name like 'mail-a'
                        THEN 'NL H'

                    -- NL S
                    WHEN referrer_type = 'campaign' AND referrer_name like 'mail-b'
                        THEN 'NL S'

                    -- NL F
                    WHEN referrer_type = 'campaign' AND referrer_name like 'mail-c'
                        THEN 'NL F'

                    -- NL B
                    WHEN referrer_type = 'campaign' AND referrer_name like 'mail-d'
                        THEN 'NL B'

                    -- NL C
                    WHEN referrer_type = 'campaign' AND referrer_name like 'mail-e'
                        THEN 'NL C'
