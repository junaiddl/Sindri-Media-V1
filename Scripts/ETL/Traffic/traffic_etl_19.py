...
class Etl:
    def __init__(self):
        ...
        # self.matomo_url = "https://matomo.dli.dk/index.php?" # HISTORICAL MATOMO URL
        self.token_auth = "auth"
        # self.token_auth = "61bfa36abbbc927f516b27dbe91a01e6" # HISTORICAL MATOMO AUTH
        self.today = date.today() - timedelta(days=1)      
        self.yesterday = self.today - timedelta(days=65)
        self.cursor = None
