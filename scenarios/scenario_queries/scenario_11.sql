...
-- week_boundaries AS (
--   SELECT
--     DATE_SUB(CURDATE(), INTERVAL DAYOFWEEK(CURDATE()) - 2 DAY) AS this_monday,
...
--     MIN(CASE WHEN week_label != 'last_week' THEN total_visits END) AS prev_min
--   FROM weekly_visits
-- )
-- SELECT
--   last_week_total,
--   prev_min,
--   CASE 
--     WHEN last_week_total < prev_min * 0.90 THEN 'True'
--     ELSE 'False'
--   END AS hit_low_last_week
-- FROM low_check;
