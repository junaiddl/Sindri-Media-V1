...
swagger_sites = [4, 10, 11, 13, 14, 15, 16, 17]
...
# Group Traffic Tasks
    ...
    # Specific tasks for Traffic sites 14 and 11
    @task()
    ...
    @task()
    def start_execution_task_18_swagger_traffic():
        from Traffic_Channels_Posting_test import start_execution
        from posting_dbt_parallel import execute
        execute(18)
        start_execution(18)
    ...
    posting_task_18 = start_execution_task_18_swagger_traffic()

    # Define task dependencies
    swagger_tasks >> traffic_tasks >> posting_task_18 >> traffic_task_14 >> traffic_task_11
