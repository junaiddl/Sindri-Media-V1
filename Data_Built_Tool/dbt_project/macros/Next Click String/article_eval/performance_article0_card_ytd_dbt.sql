{% macro string_next_click_performance_articles0_card_ytd_dbt()  %}
    ...
    CREATE PROCEDURE `performance_articles0_card_ytd_dbt_{{site}}`()
    BEGIN
    ...
    JSON_OBJECT(
            ...
            "label", "Artikler under på begge mål",
                  "hint",  "Artikler publiceret år til dato, der er under på begge mål ",
                  "value", lg.value,
