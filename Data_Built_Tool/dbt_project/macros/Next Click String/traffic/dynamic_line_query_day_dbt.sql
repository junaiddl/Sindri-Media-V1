{% macro string_dynamic_linequery_day_dbt_nextclick() %}
...
CREATE PROCEDURE `Traffic_dynamic_linequery_day_dbt_{{ siteid }}`(
	IN site INT,
   ...
   SET SESSION group_concat_max_len = 100000;
    ...
    SET @sql_query = CONCAT('
		...
		agg_on_day AS (
			...
			LEFT JOIN prod.traffic_channels_string t ON d.date = t.date AND t.siteid = {{ siteid }}
